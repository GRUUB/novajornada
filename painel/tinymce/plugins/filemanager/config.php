...
$base_url = "http://novajornada.org.br"; //url base of site if you want only relative url leave empty
$upload_dir = '/CTNJ/painel/tinymce/source/'; // path from base_url to upload base dir
